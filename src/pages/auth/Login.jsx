            ...
            <div className="mt-10">
              ...
              <AnimatedContent distance={30} direction="horizontal" reverse duration={0.6} delay={0.3}>
                {forgotPasswordStep === 1 && (
                  <div>
                    <p className="text-gray-400 text-sm mb-6">Enter your email address to receive a verification code</p>
                ...
                {forgotPasswordStep === 2 && (
                  <div>
                    <p className="text-gray-400 text-sm mb-6">Enter the 6-digit verification code sent to your email</p>
                    <form onSubmit={handleVerifyCode} className="space-y-8">
                      <GlassInput
                        ...
                        placeholder="000000"
                      />
                      <p className="text-gray-500 text-xs">Hint: The code is <span className="text-gray-400 font-semibold">123456</span></p>
                      <button
                        type="submit"
                        className="w-full bg-[#c4c4c4] hover:bg-[#e4e4e4] text-[#1a1a1a] font-bold py-4 rounded-lg tracking-widest transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-white/10 active:scale-[0.98]"
                      >
                ...
                {forgotPasswordStep === 4 && (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-white text-2xl font-bold mb-2">Password Reset Successful!</h3>
                    <p className="text-gray-400 text-sm mb-8">Your password has been reset. You can now login with your new password.</p>
                    <button
                      onClick={handleBackToLogin}
                      className="w-full bg-[#c4c4c4] hover:bg-[#e4e4e4] text-[#1a1a1a] font-bold py-4 rounded-lg tracking-widest transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-white/10 active:scale-[0.98]"
                    >
