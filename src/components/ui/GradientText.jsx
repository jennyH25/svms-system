...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative mx-auto flex max-w-fit flex-row items-center justify-center backdrop-blur transition-shadow duration-500 cursor-pointer ${showBorder ? 'py-1 px-2' : ''} ${className}`}
    ...
    >
      ...
      <motion.div
        ...
        style={{ ...gradientStyle, backgroundPosition, WebkitBackgroundClip: 'text', fontWeight }}
      >
        {children}
      </motion.div>
    </motion.div>
